...
| 2026-08-11 | Quantization runtime probe: 4B pipeline run measured on GB10, extrapolated to 27B dense (1.1–3.4 h) | kill the last runtime unknown before scheduling next-model quant windows; decides that external GPUs are off the critical path | `notes/quant-runtime-probe.md` |
