...
- **DFlash2, endgame** — all GB10 gates green (n=1319 verdict passed
  2026-08-21; see Findings). Left: the **c>8 boundary** (where does the
  gain actually invert?), the **NVFP4 non-causal kernel question** — the
  only real path to DFlash2 on the 32 GB card, possibly worth an upstream
  issue — and the **production adoption decision** on the GB10 (operator
  call, measurements done). *Goal: close the chapter.*
